...
public class DoSurvey extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null) {
            ...
            progress = singleQuestion.size() + multiQuestion.size() + openQuestion.size();
                ...
                firestore.document(key).collection("SingleChoice").document(questionKeys.get(i)).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                    ...
                    public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                        if (documentSnapshot.exists()) {
                            ...
                            firestore.document(key).collection("MultiChoice").document(questionKeys.get(finalI)).addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                @Override
                                public void onEvent(DocumentSnapshot documentSnapshot, FirebaseFirestoreException e) {
                                    if (documentSnapshot.exists()) {
        ...
        if (openI < openQuestionList.size()) {
            ...
            btnNext.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (openI >= openQuestionList.size()) {
                        Toast.makeText(DoSurvey.this, "Finished!", Toast.LENGTH_SHORT).show();
